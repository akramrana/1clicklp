...
Vvveb.Builder = {
                ...
                for (i in components)
                {
                    ...
                    if (component)
                    {
                        ...
                        if (component.image) {
                            ...
                            item.css({
                                backgroundImage: "url(" + baseUrl + '/vvvebjs/libs/builder/' + component.image + ")",
    ...
    _frameLoaded: function () {
        ...
        self.frameHead.append('\n<link data-vvveb-helpers href="' + Vvveb.baseUrl + '../../css/vvvebjs-editor-helpers.css" rel="stylesheet">');
