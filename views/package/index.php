                    ...
                    'value' => function ($model, $url) {
                        return '<div class="onoffswitch">'
                                . Html::checkbox('onoffswitch', $model->is_active, [
                                    ...
                                    'id' => "myonoffswitch" . $model->package_id,
                                    'onclick' => 'app.changeStatus("package/activate",this,' . $model->package_id . ')',
                                ])
                                . '<label class="onoffswitch-label" for="myonoffswitch' . $model->package_id . '"></label></div>';
                    },
