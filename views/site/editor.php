...
<html lang="en">
    <head>
        ...
        <link href="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/css/editor.css" rel="stylesheet">
        <link href="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/css/line-awesome.css" rel="stylesheet">
    </head>
    <body>
        ...
        <div id="vvveb-builder">
            ...
            <div id="top-panel">
                <img src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/img/logo.png" alt="Vvveb" class="float-left" id="logo">
                ...
                <div class="btn-group float-left" role="group">
                    <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
                        <img src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/icons/file-manager-layout.svg" width="20px" height="20px">
                    </button>
                    ...
                    <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
                        <img src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/icons/left-column-layout.svg" width="20px" height="20px">
                    </button>
                    ...
                    <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
                        <img src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/icons/right-column-layout.svg" width="20px" height="20px">
                    </button>
                </div>
        ...
        <!-- jquery-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/js/jquery.min.js"></script>
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/js/jquery.hotkeys.js"></script>

        <!-- bootstrap-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/js/popper.min.js"></script>
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/js/bootstrap.min.js"></script>

        <!-- builder code-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/builder.js"></script>	
        <!-- undo manager-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/undo.js"></script>	
        <!-- inputs-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/inputs.js"></script>	
        ...
        <!-- components-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/components-server.js"></script>	
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/components-bootstrap4.js"></script>	
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/components-widgets.js"></script>	

        <!-- blocks-->
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/blocks-bootstrap4.js"></script>	

        <!-- plugins -->

        <!-- code mirror - code editor syntax highlight -->
        <link href="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/codemirror/lib/codemirror.css" rel="stylesheet"/>
        <link href="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/codemirror/theme/material.css" rel="stylesheet"/>
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/codemirror/lib/codemirror.js"></script>
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/codemirror/lib/xml.js"></script>
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/codemirror/lib/formatting.js"></script>
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>vvvebjs/libs/builder/plugin-codemirror.js"></script>	
        ...
        <script src="<?php echo \yii\helpers\BaseUrl::home() ?>libs/autocomplete/jquery.autocomplete.js"></script>	

        <script>
            $(document).ready(function ()
            {
                Vvveb.Builder.init('<?php echo \yii\helpers\BaseUrl::home() ?>site/index', function () {
